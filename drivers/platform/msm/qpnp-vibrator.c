...
#define SHVIBRATOR_DBG_LOG(fmt, args...) \
	if( shvibrator_debug_log == 1 ){ \
		printk( KERN_DEBUG "[shvibrator][%s] " fmt "\n", __func__, ## args ); \
	}
/*
...
#ifdef CONFIG_QPNP_SCVIBRATOR
	SHVIBRATOR_DBG_LOG("func called. (on=%d)", on);
#endif /* CONFIG_QPNP_SCVIBRATOR */
...
#ifdef CONFIG_QPNP_SCVIBRATOR
func_fin:
	SHVIBRATOR_DBG_LOG("func exit. (rc=%d)", rc);
#endif /* CONFIG_QPNP_SCVIBRATOR */
...
#ifdef CONFIG_QPNP_SCVIBRATOR
	SHVIBRATOR_DBG_LOG("func called. (value=%d)", value);
#endif /* CONFIG_QPNP_SCVIBRATOR */
...
#ifdef CONFIG_QPNP_SCVIBRATOR
	SHVIBRATOR_DBG_LOG("func called.");
#endif /* CONFIG_QPNP_SCVIBRATOR */
