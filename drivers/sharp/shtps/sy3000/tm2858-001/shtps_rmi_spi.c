...
#define SHTPS_DEF_DRUMMING_SET_REG_ENABLE
#define SHTPS_DEF_PALM_SET_REG_ENABLE
 ...
 */
		...
		#include "shtps_fw_tm2858-001_a1.h"
		#include "shtps_fw_tm2858-001_b0.h"
		#include "shtps_fw_tm2858-001.h"
	#else
		#include "shtps_fw_tm2858-001.h"
...
#define SHTPS_TOUCH_CANCEL_COORDINATES_Y		9999
	...
	#define SHTPS_HOVER_CTRL_BASE_ADR_A1			0x09
		...
		static int hover_report_info_calc_type =			0;
			...
			static int SHTPS_HOVER_EDGE_LOST_RESOLV_DISABLE = 0;
			...
			#if defined( SHTPS_HOVER_EDGE_LOST_RESOLV_ENABLE )
				module_param(SHTPS_HOVER_EDGE_LOST_RESOLV_DISABLE, int, S_IRUGO | S_IWUSR);
			#endif /* SHTPS_HOVER_EDGE_LOST_RESOLV_ENABLE */
		...
		#if defined( SHTPS_HOVER_EDGE_LOST_RESOLV_ENABLE )
			#define SHTPS_HOVER_EDGE_LOST_RESOLV_DISABLE	0
		#endif /* SHTPS_HOVER_EDGE_LOST_RESOLV_ENABLE */
	...
	#define SHTPS_LPWG_REPORT_WG_ONLY						0x02
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_KEY_DISABLE_EFFECT_AREA =			100;
		...
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_KEY_DISABLE_EFFECT_AREA				100
...
#define SHTPS_GET_HW_VERSION_RET_MP			7
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_CLING_REJECT_HOVER_ENABLE =					1;
		static int SHTPS_CLING_REJECT_FINGER_ENABLE =					1;
		...
		static int SHTPS_CLING_REJECT_HOVER_MODE_1_ENABLE = 0;
		static int SHTPS_CLING_REJECT_HOVER_MODE_2_ENABLE = 1;
		static int SHTPS_CLING_REJECT_HOVER_MODE_3_ENABLE = 1;
		static int SHTPS_CLING_REJECT_HOVER_MODE_4_ENABLE = 1;

		static int SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_W =			60;
		static int SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_X = 			200;
		static int SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_Y = 			200;
		static int SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_W = 	50;
		static int SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_Z = 	30;
		static int SHTPS_CLING_REJECT_FINGER_JUMP_CNT_MAX = 			10;
		static int SHTPS_CLING_REJECT_FINGER_TU_NEGLECT_TIME_MS = 		100;
		static int SHTPS_CLING_REJECT_FINGER_STATIC_NUM_THRESH = 		3;
		static int SHTPS_CLING_REJECT_FINGER_STATIC_TIME_MS =			1000;
		static int SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_W =			1;
		static int SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_Z =			1;

		static int SHTPS_CLING_REJECT_FINGER_MODE_1_ENABLE = 0;
		static int SHTPS_CLING_REJECT_FINGER_MODE_2_ENABLE = 1;
		static int SHTPS_CLING_REJECT_FINGER_MODE_3_ENABLE = 1;
		static int SHTPS_CLING_REJECT_FINGER_MODE_4_ENABLE = 0;

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_CLING_REJECT_HOVER_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_ENABLE, int, S_IRUGO | S_IWUSR);
			...
			module_param(SHTPS_CLING_REJECT_HOVER_MODE_1_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_HOVER_MODE_2_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_HOVER_MODE_3_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_HOVER_MODE_4_ENABLE, int, S_IRUGO | S_IWUSR);

			module_param(SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_W, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_X, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_Y, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_W, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_Z, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_JUMP_CNT_MAX, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_TU_NEGLECT_TIME_MS, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_STATIC_NUM_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_STATIC_TIME_MS, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_W, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_Z, int, S_IRUGO | S_IWUSR);

			module_param(SHTPS_CLING_REJECT_FINGER_MODE_1_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_MODE_2_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_MODE_3_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_CLING_REJECT_FINGER_MODE_4_ENABLE, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_CLING_REJECT_HOVER_ENABLE						1
		#define SHTPS_CLING_REJECT_FINGER_ENABLE					1
		...
		#define SHTPS_CLING_REJECT_HOVER_MODE_1_ENABLE					0
		#define SHTPS_CLING_REJECT_HOVER_MODE_2_ENABLE					1
		#define SHTPS_CLING_REJECT_HOVER_MODE_3_ENABLE					1
		#define SHTPS_CLING_REJECT_HOVER_MODE_4_ENABLE					1

		#define SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_W				60
		#define SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_X					200
		#define SHTPS_CLING_REJECT_FINGER_JUMP_THRESH_Y					200
		#define SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_W			50
		#define SHTPS_CLING_REJECT_FINGER_DETECT_THRESH_DIFF_Z			30
		#define SHTPS_CLING_REJECT_FINGER_JUMP_CNT_MAX					10
		#define SHTPS_CLING_REJECT_FINGER_TU_NEGLECT_TIME_MS			100
		#define SHTPS_CLING_REJECT_FINGER_STATIC_NUM_THRESH				3
		#define SHTPS_CLING_REJECT_FINGER_STATIC_TIME_MS				1000
		#define SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_W					1
		#define SHTPS_CLING_REJECT_FINGER_STATIC_DIFF_Z					1

		#define SHTPS_CLING_REJECT_FINGER_MODE_1_ENABLE			0
		#define SHTPS_CLING_REJECT_FINGER_MODE_2_ENABLE			1
		#define SHTPS_CLING_REJECT_FINGER_MODE_3_ENABLE			1
		#define SHTPS_CLING_REJECT_FINGER_MODE_4_ENABLE			0
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_HOVER_JITTER_FILTER_DISABLE =				0;
		static int SHTPS_HOVER_JITTER_FILTER_THRESHOLD =			15;
		static int SHTPS_HOVER_JITTER_FILTER_JUMP_THRESHOLD =		30;
		static int SHTPS_HOVER_JITTER_FILTER_JUMP_COUNT =			5;

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_HOVER_JITTER_FILTER_DISABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_HOVER_JITTER_FILTER_THRESHOLD, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_HOVER_JITTER_FILTER_JUMP_THRESHOLD, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_HOVER_JITTER_FILTER_JUMP_COUNT, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_HOVER_JITTER_FILTER_DISABLE					0
		#define SHTPS_HOVER_JITTER_FILTER_THRESHOLD					15
		#define SHTPS_HOVER_JITTER_FILTER_JUMP_THRESHOLD			30
		#define SHTPS_HOVER_JITTER_FILTER_JUMP_COUNT				5
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#define SHTPS_DRAG_SMOOTH_FIXED_TO_INT(val)			((val) >> SHTPS_DRAG_SMOOTH_FIXED_SHIFT)
...
#if defined( SHTPS_DYNAMIC_RESET_CONTROL_ENABLE )
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int	SHTPS_DYNAMIC_RESET_F54_COMMAND_ENABLE = 	1;
		static int	SHTPS_DYNAMIC_RESET_COAXIAL_PEN_ENABLE = 	0;
		static int	SHTPS_DYNAMIC_RESET_COAXIAL_PEN_TOUCH_COUNT = 	20;
		static int	SHTPS_DYNAMIC_RESET_LOG_ENABLE = 	0;
		
		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_DYNAMIC_RESET_F54_COMMAND_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_DYNAMIC_RESET_COAXIAL_PEN_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_DYNAMIC_RESET_COAXIAL_PEN_TOUCH_COUNT, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_DYNAMIC_RESET_LOG_ENABLE, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	...
	#else
		#define SHTPS_DYNAMIC_RESET_F54_COMMAND_ENABLE			1
		#define SHTPS_DYNAMIC_RESET_COAXIAL_PEN_ENABLE			0
		#define SHTPS_DYNAMIC_RESET_COAXIAL_PEN_TOUCH_COUNT		20
		...
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_SUSPEND_SPI_RESUME_FUNC_DELAY			0
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
#endif /* SHTPS_GUARANTEE_SPI_ACCESS_IN_WAKE_ENABLE */

#if defined( SHTPS_DEF_DRUMMING_SET_REG_ENABLE )
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int	SHTPS_REG_PRM_DRUMMING_ACCELERATION_THRESH = 	0x07;
		static int	SHTPS_REG_PRM_DRUMMING_MIN_SEPARATION_THRESH = 	0x0A;
		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_REG_PRM_DRUMMING_ACCELERATION_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_REG_PRM_DRUMMING_MIN_SEPARATION_THRESH, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_REG_PRM_DRUMMING_ACCELERATION_THRESH			0x07
		#define SHTPS_REG_PRM_DRUMMING_MIN_SEPARATION_THRESH			0x0A
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
#endif /* SHTPS_DEF_DRUMMING_SET_REG_ENABLE */

#if defined( SHTPS_DEF_PALM_SET_REG_ENABLE )
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int	SHTPS_REG_PRM_PALM_AMPLITUDE_THRESH = 	0x28;
		static int	SHTPS_REG_PRM_PALM_AREA_THRESH = 	0x14;
		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_REG_PRM_PALM_AMPLITUDE_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_REG_PRM_PALM_AREA_THRESH, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_REG_PRM_PALM_AMPLITUDE_THRESH			0x28
		#define SHTPS_REG_PRM_PALM_AREA_THRESH			0x14
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
#endif /* SHTPS_DEF_PALM_SET_REG_ENABLE */
...
struct shtps_lpwg_ctrl{
	...
	#if defined(SHTPS_LPWG_CHANGE_SWIPE_DISTANCE_ENABLE)
        u8                          fn12_ctrl18_disable_settings[19];
        u8                          fn12_ctrl18_enable_settings[19];
	#endif /* SHTPS_LPWG_CHANGE_SWIPE_DISTANCE_ENABLE */
...
#if defined( SHTPS_DEF_DRUMMING_SET_REG_ENABLE )
static void shtps_set_drumming_reg_threshold(struct shtps_rmi_spi *ts)
{
	u8 buf[5];
	
	shtps_rmi_read_packet(ts, ts->map.fn12.ctrl.num[10].addr, buf, sizeof(buf));
	buf[3] = SHTPS_REG_PRM_DRUMMING_ACCELERATION_THRESH;
	buf[4] = SHTPS_REG_PRM_DRUMMING_MIN_SEPARATION_THRESH;
	shtps_rmi_write_packet(ts, ts->map.fn12.ctrl.num[10].addr, buf, sizeof(buf));
}
#endif /* defined( SHTPS_DEF_DRUMMING_SET_REG_ENABLE ) */

#if defined( SHTPS_DEF_PALM_SET_REG_ENABLE )
static void shtps_set_palm_reg_threshold(struct shtps_rmi_spi *ts)
{
	u8 buf[6];
	
	shtps_rmi_read_packet(ts, ts->map.fn12.ctrl.num[15].addr, buf, sizeof(buf));
	buf[4] = SHTPS_REG_PRM_PALM_AMPLITUDE_THRESH;
	buf[5] = SHTPS_REG_PRM_PALM_AREA_THRESH;
	shtps_rmi_write_packet(ts, ts->map.fn12.ctrl.num[15].addr, buf, sizeof(buf));
}
#endif /* defined( SHTPS_DEF_PALM_SET_REG_ENABLE ) */
...
static void shtps_get_lpwg_def_settings(struct shtps_rmi_spi *ts)
{
	...
	ts->lpwg.fn12_ctrl27_enable_settings[5] = SHTPS_LPWG_MAX_ACTIVE_DURATION_TIME;
		...
		ts->lpwg.fn12_ctrl18_enable_settings[0x12] = SHTPS_LPWG_SWIPE_MINIMUM_DISTANCE;
	#endif /* SHTPS_LPWG_CHANGE_SWIPE_DISTANCE_ENABLE */
}
...
#if defined( SHTPS_DEF_DRUMMING_SET_REG_ENABLE )
		shtps_set_drumming_reg_threshold(ts);
#endif /* SHTPS_DEF_DRUMMING_SET_REG_ENABLE */

#if defined( SHTPS_DEF_PALM_SET_REG_ENABLE )
		shtps_set_palm_reg_threshold(ts);
#endif /* SHTPS_DEF_PALM_SET_REG_ENABLE */
