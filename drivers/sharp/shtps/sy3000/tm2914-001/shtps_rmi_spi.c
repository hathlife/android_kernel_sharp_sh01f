...
#define SHTPS_SMOOTH_FILTER_ENABLE
...
#define SHTPS_TOUCH_CANCEL_COORDINATES_Y		9999
	...
	#define	SHTPS_LOG_WAKEUP_FAIL_TOUCH_EVENT_REJECT(...)					\
		...
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X =	62;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y =	791;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE = 		612;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO =		100;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2 =		73;
		static int SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME =	507;
		...
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_X	62
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_AREA_THRESH_Y	791
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_DISTANCE		612
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO		100
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_Z_RATIO_2		73
		#define SHTPS_EDGE_FAIL_TOUCH_REJECT_EFFECT_TIME	507
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_ENABLE =			0;
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_AREA =				350;
		static int SHTPS_GRIP_FAIL_TOUCH_REJECT_W_THRESH =			15;

		static int SHTPS_GRIP_FAIL_FLICK_REJECT_ENABLE =			0;
		static int SHTPS_GRIP_FAIL_FLICK_REJECT_AREA =				350;
		static int SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH =			15;
		...
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_ENABLE				0
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_AREA				350
		#define SHTPS_GRIP_FAIL_TOUCH_REJECT_W_THRESH			15

		#define SHTPS_GRIP_FAIL_FLICK_REJECT_ENABLE				0
		#define SHTPS_GRIP_FAIL_FLICK_REJECT_AREA				350
		#define SHTPS_GRIP_FAIL_FLICK_REJECT_W_THRESH			15
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
	...
	#define SHTPS_REG_OFFSET_SEGMENTATION_AGGRESSIVENESS	0x1F

	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int SHTPS_PINCH_FAIL_RESPONSE_REJECT_ENABLE =		1;
		static int SHTPS_PINCH_FAIL_FINGER_1ST_DISTANCE_THRESH =	500;
		static int SHTPS_PINCH_FAIL_FINGER_2ND_DISTANCE_THRESH =	430;
		static int SHTPS_SEGMENTATION_AGGRESSIVENESS_SET_VAL = 		0xFF;

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_PINCH_FAIL_RESPONSE_REJECT_ENABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_PINCH_FAIL_FINGER_1ST_DISTANCE_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_PINCH_FAIL_FINGER_2ND_DISTANCE_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SEGMENTATION_AGGRESSIVENESS_SET_VAL, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_PINCH_FAIL_RESPONSE_REJECT_ENABLE			1
		#define SHTPS_PINCH_FAIL_FINGER_1ST_DISTANCE_THRESH		500
		#define SHTPS_PINCH_FAIL_FINGER_2ND_DISTANCE_THRESH		430
		#define SHTPS_SEGMENTATION_AGGRESSIVENESS_SET_VAL		0xFF
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */

	#if defined( SHTPS_LOG_DEBUG_ENABLE )
		static int SHTPS_PINCH_FAIL_RESPONSE_REJECT_LOG_ENABLE = 0;
		module_param(SHTPS_PINCH_FAIL_RESPONSE_REJECT_LOG_ENABLE, int, S_IRUGO | S_IWUSR);
...
#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
	#if defined( SHTPS_DEBUG_VARIABLE_DEFINES )
		static int	SHTPS_SMOOTH_FILTER_DISABLE =				0;
		static int	SHTPS_SMOOTH_FILTER_VALID_COUNT =			20;
		static int	SHTPS_SMOOTH_FILTER_VALID_THRESH =			5;
		static int	SHTPS_SMOOTH_FILTER_VALID_CHANGE_ACC =		50;
		static int	SHTPS_SMOOTH_FILTER_INVALID_CHANGE_ACC =	100;
		static int	SHTPS_SMOOTH_FILTER_TIME_THRESH =			20;
		static int	SHTPS_SMOOTH_FILTER_BACK_ALLOW_DIFF =		10;
		static int	SHTPS_SMOOTH_FILTER_BACK_OFFSET_STRENGTH =	30;
		static int	SHTPS_SMOOTH_FILTER_FRONT_ALLOW_DIFF =		5;
		static int	SHTPS_SMOOTH_FILTER_FRONT_OFFSET_STRENGTH =	30;

		#if defined( SHTPS_MODULE_PARAM_ENABLE )
			module_param(SHTPS_SMOOTH_FILTER_DISABLE, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_VALID_COUNT, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_VALID_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_VALID_CHANGE_ACC, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_INVALID_CHANGE_ACC, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_TIME_THRESH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_BACK_ALLOW_DIFF, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_BACK_OFFSET_STRENGTH, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_FRONT_ALLOW_DIFF, int, S_IRUGO | S_IWUSR);
			module_param(SHTPS_SMOOTH_FILTER_FRONT_OFFSET_STRENGTH, int, S_IRUGO | S_IWUSR);
		#endif /* SHTPS_MODULE_PARAM_ENABLE */
	#else
		#define SHTPS_SMOOTH_FILTER_DISABLE						0
		#define SHTPS_SMOOTH_FILTER_VALID_COUNT					20
		#define SHTPS_SMOOTH_FILTER_VALID_THRESH				5
		#define SHTPS_SMOOTH_FILTER_VALID_CHANGE_ACC			50
		#define SHTPS_SMOOTH_FILTER_INVALID_CHANGE_ACC			100
		#define SHTPS_SMOOTH_FILTER_TIME_THRESH					20
		#define SHTPS_SMOOTH_FILTER_BACK_ALLOW_DIFF				10
		#define SHTPS_SMOOTH_FILTER_BACK_OFFSET_STRENGTH		30
		#define SHTPS_SMOOTH_FILTER_FRONT_ALLOW_DIFF			5
		#define SHTPS_SMOOTH_FILTER_FRONT_OFFSET_STRENGTH		30
	#endif /* SHTPS_DEBUG_VARIABLE_DEFINES ) */
#endif /* SHTPS_SMOOTH_FILTER_ENABLE */
...
#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
struct shtps_smooth_filter {
	unsigned long time;
	unsigned short pre_pos;
	int slow_count;
	int pre_dir;
	int speed;
	int count;
...
struct shtps_rmi_spi {
	...
	#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
		struct shtps_smooth_filter		smooth_filter[SHTPS_FINGER_MAX];
	#endif /* SHTPS_SMOOTH_FILTER_ENABLE */
};
...
#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
static inline int shtps_pos_smooth_filter_abs(int a)
{
	return (a > 0)? a : -a;
}

static inline int shtps_pos_smooth_filter_dir(int a, int b)
{
	return (a == b)? 0 : ((a < b)? 1:-1);
}

static inline void shtps_pos_smooth_filter_timesub(struct timeval *cur, struct timeval *pre, struct timeval *result)
{
	result->tv_sec  = cur->tv_sec  - pre->tv_sec;
	result->tv_usec = cur->tv_usec - pre->tv_usec;
...
static void shtps_pos_smooth_filter_init(struct shtps_rmi_spi *ts, u8 finger)
{
	ts->smooth_filter[finger].time = jiffies;
	ts->smooth_filter[finger].speed= 0;
	ts->smooth_filter[finger].count= 0;

	ts->smooth_filter[finger].real_pre_speed = 0;
	do_gettimeofday(&ts->smooth_filter[finger].pre_tv);
}

static void shtps_pos_smooth_filter(struct shtps_rmi_spi *ts, struct shtps_touch_info *info)
{
	u8 i, j;
	u8 init = 0;
	u8 fingerMax = shtps_get_fingermax(ts);
	
	if(SHTPS_SMOOTH_FILTER_DISABLE){
		return;
	}
	...
	for(i = 0;i < fingerMax;i++){
		if(info->fingers[i].state != SHTPS_TOUCH_STATE_NO_TOUCH){
			if(ts->report_info.fingers[i].state == SHTPS_TOUCH_STATE_NO_TOUCH){
				shtps_pos_smooth_filter_init(ts, i);
				SHTPS_LOG_DBG_PRINT("%s() [%d] init by touch down", __func__, i);
			}else{
				int is_timeover= time_after(jiffies, ts->smooth_filter[i].time + msecs_to_jiffies(SHTPS_SMOOTH_FILTER_TIME_THRESH));
				int pre_dir    = ts->smooth_filter[i].pre_dir;
				int cur_dir    = shtps_pos_smooth_filter_dir(ts->smooth_filter[i].pre_pos, info->fingers[i].y);
				int pre_speed  = ts->smooth_filter[i].speed;
				u8  use_avg    = 1;
				
				int acc;
				int real_cur_speed;
				int offset_dir = (ts->smooth_filter[i].speed >= 0)? 1 : -1;
				struct timeval tv;
				struct timeval tv_sub;
				do_gettimeofday(&tv);
				shtps_pos_smooth_filter_timesub(&tv, &ts->smooth_filter[i].pre_tv, &tv_sub);
				
				real_cur_speed = ((info->fingers[i].y - ts->smooth_filter[i].pre_pos) * 1000) / ((tv_sub.tv_sec * 1000000 + tv_sub.tv_usec) / 1000);
				acc = (real_cur_speed - ts->smooth_filter[i].real_pre_speed) / 
							((tv_sub.tv_sec * 1000000 + tv_sub.tv_usec) / 1000);
			
				ts->smooth_filter[i].pre_tv.tv_sec = tv.tv_sec;
				ts->smooth_filter[i].pre_tv.tv_usec= tv.tv_usec;
				ts->smooth_filter[i].real_pre_speed= real_cur_speed;

				/** check whether it is necessary to terminate the filter mode. */
				if(is_timeover){
					init = 1;
					shtps_pos_smooth_filter_init(ts, i);
					SHTPS_LOG_DBG_PRINT("%s() [%d] init by timeover (interval=%d)", __func__, i, 
						jiffies_to_msecs(jiffies - ts->smooth_filter[i].time));
				}else if((ts->smooth_filter[i].count >= SHTPS_SMOOTH_FILTER_VALID_COUNT && 
				          (shtps_pos_smooth_filter_abs(acc) * -offset_dir) > SHTPS_SMOOTH_FILTER_INVALID_CHANGE_ACC))
				{
					init = 1;
					shtps_pos_smooth_filter_init(ts, i);
					SHTPS_LOG_DBG_PRINT("%s() [%d][end condition] init by move (acceleration=%d, dir=%d)", __func__, i, acc, offset_dir);
				}else if((ts->smooth_filter[i].count > 0 && 
						  shtps_pos_smooth_filter_abs(info->fingers[i].y - ts->smooth_filter[i].pre_pos) < SHTPS_SMOOTH_FILTER_VALID_THRESH))
				{
					init = 1;
					shtps_pos_smooth_filter_init(ts, i);
					SHTPS_LOG_DBG_PRINT("%s() [%d][end condition] init by small move (diff pos=%d)", __func__, i, (info->fingers[i].y - ts->smooth_filter[i].pre_pos));
				}else if((ts->smooth_filter[i].count > 0 && 
						  shtps_pos_smooth_filter_abs(acc) > SHTPS_SMOOTH_FILTER_VALID_CHANGE_ACC))
				{
					init = 1;
					shtps_pos_smooth_filter_init(ts, i);
					SHTPS_LOG_DBG_PRINT("%s() [%d][start condition] init by move (acceleration=%d)", __func__, i, acc);
				}else if(ts->smooth_filter[i].count > 0 && (pre_dir != 0 && cur_dir != 0 && pre_dir != cur_dir)){
					init = 1;
					shtps_pos_smooth_filter_init(ts, i);
					SHTPS_LOG_DBG_PRINT("%s() [%d] init by direction's chenge (pre dir=%d, cur dir=%d)", __func__, i, pre_dir, cur_dir);
				}
				
				if(!init){
					/** set current information. */
					ts->smooth_filter[i].time    = jiffies;
					ts->smooth_filter[i].pre_dir = cur_dir;
					ts->smooth_filter[i].speed   = info->fingers[i].y - ts->report_info.fingers[i].y;
					ts->smooth_filter[i].pre_pos = info->fingers[i].y;
					
					if(ts->smooth_filter[i].count < SHTPS_SMOOTH_FILTER_VALID_COUNT){
						ts->smooth_filter[i].speed_hist[ts->smooth_filter[i].count] = ts->smooth_filter[i].speed;
						ts->smooth_filter[i].count++;
					}else{
						for(j = 0;j < SHTPS_SMOOTH_FILTER_VALID_COUNT - 1;j++){
							ts->smooth_filter[i].speed_hist[j] = ts->smooth_filter[i].speed_hist[j+1];
						}
					}
					...
					if(ts->smooth_filter[i].count >= SHTPS_SMOOTH_FILTER_VALID_COUNT){
						int y;
						int allow_diff_front, allow_diff_back;
						int diff_pos;
						int new_pos;
						
						allow_diff_front = SHTPS_SMOOTH_FILTER_FRONT_ALLOW_DIFF;
						allow_diff_back  = SHTPS_SMOOTH_FILTER_BACK_ALLOW_DIFF;
						
						y = ts->report_info.fingers[i].y + pre_speed;
						diff_pos = info->fingers[i].y - y;
						
						if((pre_speed != 0) && ((pre_speed < 0 && diff_pos > allow_diff_front) || (pre_speed > 0 && -diff_pos > allow_diff_front))){
							use_avg = 0;
							ts->smooth_filter[i].speed = pre_speed + (diff_pos * SHTPS_SMOOTH_FILTER_FRONT_OFFSET_STRENGTH) / 100;
							SHTPS_LOG_DBG_PRINT("%s() [%d][1] speed=%d (allow_diff=%d, diff_pos=%d, offset=%d)", __func__, i, ts->smooth_filter[i].speed,
														allow_diff_front, diff_pos, (diff_pos * SHTPS_SMOOTH_FILTER_FRONT_OFFSET_STRENGTH) / 100);
						}else if((pre_speed != 0) && ((pre_speed < 0 && -diff_pos > allow_diff_back) || (pre_speed > 0 && diff_pos > allow_diff_back))){
							use_avg = 0;
							ts->smooth_filter[i].speed = pre_speed + (diff_pos * SHTPS_SMOOTH_FILTER_BACK_OFFSET_STRENGTH) / 100;
							SHTPS_LOG_DBG_PRINT("%s() [%d][2] speed=%d (allow_diff=%d, diff_pos=%d, offset=%d)", __func__, i, ts->smooth_filter[i].speed,
														allow_diff_back, diff_pos, (diff_pos * SHTPS_SMOOTH_FILTER_BACK_OFFSET_STRENGTH) / 100);
						}else{
							ts->smooth_filter[i].speed = pre_speed;
							SHTPS_LOG_DBG_PRINT("%s() [%d][0] speed=%d", __func__, i, ts->smooth_filter[i].speed);
						}
						
						if((ts->smooth_filter[i].speed == 0) || 
							(cur_dir > 0 && ts->smooth_filter[i].speed < 0) ||
							(cur_dir < 0 && ts->smooth_filter[i].speed > 0))
						{
							ts->smooth_filter[i].speed = cur_dir;
						}
						
						/** calc average speed */
						ts->smooth_filter[i].speed_hist[SHTPS_SMOOTH_FILTER_VALID_COUNT - 1] = ts->smooth_filter[i].speed;
						if(use_avg){
							ts->smooth_filter[i].speed = 0;
							for(j = 0;j < SHTPS_SMOOTH_FILTER_VALID_COUNT;j++){
								ts->smooth_filter[i].speed += ts->smooth_filter[i].speed_hist[j];
							}
							ts->smooth_filter[i].speed /= SHTPS_SMOOTH_FILTER_VALID_COUNT;
						}
						
						/** set offset position */
						new_pos = ts->report_info.fingers[i].y + ts->smooth_filter[i].speed;
						if(new_pos < 0){
							new_pos = 0;
						}else if(new_pos >= CONFIG_SHTPS_SY3000_PANEL_SIZE_Y){
							new_pos = CONFIG_SHTPS_SY3000_PANEL_SIZE_Y - 1;
						}
						SHTPS_LOG_DBG_PRINT("%s() [%d] y=%d -> %d (speed=%d)", __func__, i, info->fingers[i].y, new_pos, ts->smooth_filter[i].speed);
						info->fingers[i].y = new_pos;
					}
				}
			}
		}
...
#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
	shtps_pos_smooth_filter(ts, info);
#endif /* SHTPS_SMOOTH_FILTER_ENABLE */
...
static void shtps_event_force_touchup(struct shtps_rmi_spi *ts)
{
	...
	#if defined( SHTPS_SMOOTH_FILTER_ENABLE )
		memset(&ts->smooth_filter, 0, sizeof(ts->smooth_filter));
	#endif /* SHTPS_SMOOTH_FILTER_ENABLE */
