...
#        dtb-$(CONFIG_MACH_WHAMU)	+= msm8974-sharp-whamu-v2.2.dtb
        ...
        dtb-$(CONFIG_MACH_LYNX_DL40)	+= msm8974-sharp-dl40-v2.0-1.dtb
        dtb-$(CONFIG_MACH_LYNX_DL40)	+= msm8974-sharp-dl40-v2.2.dtb
        ...
        dtb-$(CONFIG_MACH_MM4)	+= msm8974-sharp-mm4-v2.0-1.dtb
        dtb-$(CONFIG_MACH_MM4)	+= msm8974-sharp-mm4-v2.2.dtb
